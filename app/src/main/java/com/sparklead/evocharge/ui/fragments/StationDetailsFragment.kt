...
class StationDetailsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        cor.add(CarouselItem("https://firebasestorage.googleapis.com/v0/b/vepaso-75c35.appspot.com/o/Component%202%20(3).png?alt=media&token=2be17462-832c-4992-984d-10e64b57114f",R.string.app_name))
